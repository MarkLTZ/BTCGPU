...
```shell
$ valgrind --suppressions=contrib/valgrind.supp src/test/test_bgold
$ valgrind --suppressions=contrib/valgrind.supp --leak-check=full \
      --show-leak-kinds=all src/test/test_bgold --log_level=test_suite
...
# A coverage report will now be accessible at `./test_bgold.coverage/index.html`.
```
